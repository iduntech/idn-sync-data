...
def edf_info_all_channels(
    dataset: np.ndarray, chanlocs: list, sample_freq: 250, dimension: "uV"
):
    """
...
def edf_info_single_channel(
    dataset: np.ndarray, chanloc: list, sample_freq: 250, dimension: "uV"
):
    """
